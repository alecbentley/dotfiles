...
"ident by an additional 3 characters on wrapped lines, when line >= 40 char,
"put 'showbreak' at start of line
...
"Fake Lorem Ipsum text generator
"use in normal mode :Lorem20 (where 20 is the number of words to insert)
...
"Treesitter plugin (better syntax highlighting)
"(turn off polyglot if using this)
...
"link to treesitter lua config file
